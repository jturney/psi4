...
public:
    ...
    TwoElectronInt(std::shared_ptr<BasisSet> bs1, std::shared_ptr<BasisSet> bs2,
...
{
public:
    ERI(std::shared_ptr<BasisSet> bs1, std::shared_ptr<BasisSet> bs2,
        std::shared_ptr<BasisSet> bs3, std::shared_ptr<BasisSet> bs4,
        int deriv = 0, bool use_shell_pairs = false);
...
{
public:
    F12(std::shared_ptr<CorrelationFactor> cf, std::shared_ptr<BasisSet> bs1, std::shared_ptr<BasisSet> bs2,
        std::shared_ptr<BasisSet> bs3, std::shared_ptr<BasisSet> bs4, int deriv = 0, bool use_shell_pairs = false);
...
{
public:
    F12Scaled(std::shared_ptr<CorrelationFactor> cf, std::shared_ptr<BasisSet> bs1, std::shared_ptr<BasisSet> bs2,
              std::shared_ptr<BasisSet> bs3, std::shared_ptr<BasisSet> bs4, int deriv = 0, bool use_shell_pairs = false);
...
{
public:
    F12Squared(std::shared_ptr<CorrelationFactor> cf, std::shared_ptr<BasisSet> bs1, std::shared_ptr<BasisSet> bs2,
               std::shared_ptr<BasisSet> bs3, std::shared_ptr<BasisSet> bs4, int deriv = 0, bool use_shell_pairs = false);
...
{
public:
    F12G12(std::shared_ptr<CorrelationFactor> cf, std::shared_ptr<BasisSet> bs1, std::shared_ptr<BasisSet> bs2,
           std::shared_ptr<BasisSet> bs3, std::shared_ptr<BasisSet> bs4, int deriv = 0, bool use_shell_pairs = false);
...
{
public:
    F12DoubleCommutator(std::shared_ptr<CorrelationFactor> cf, std::shared_ptr<BasisSet> bs1, std::shared_ptr<BasisSet> bs2,
                        std::shared_ptr<BasisSet> bs3, std::shared_ptr<BasisSet> bs4, int deriv = 0, bool use_shell_pairs = false);
...
{
public:
    ErfERI(double omega, std::shared_ptr<BasisSet> bs1, std::shared_ptr<BasisSet> bs2,
           std::shared_ptr<BasisSet> bs3, std::shared_ptr<BasisSet> bs4, int deriv = 0, bool use_shell_pairs = false);
...
{
public:
    ErfComplementERI(double omega, std::shared_ptr<BasisSet> bs1, std::shared_ptr<BasisSet> bs2,
                     std::shared_ptr<BasisSet> bs3, std::shared_ptr<BasisSet> bs4, int deriv = 0, bool use_shell_pairs = false);
