...
TracelessQuadrupoleInt::TracelessQuadrupoleInt(std::shared_ptr<BasisSet> bs1, std::shared_ptr<BasisSet> bs2) :
    OneBodyAOInt(bs1, bs2), overlap_recur_(bs1->max_am()+2, bs2->max_am()+2)
{
