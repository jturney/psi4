...
OverlapInt::OverlapInt(std::vector<SphericalTransform> &st, std::shared_ptr<BasisSet> bs1,
    ...
    engine0_ = std::unique_ptr<libint2::Engine>(new libint2::Engine(libint2::Operator::overlap, max_nprim, max_am, 0));
    ...
    if (deriv == 1) {
        ...
        engine1_ =
            std::unique_ptr<libint2::Engine>(new libint2::Engine(libint2::Operator::overlap, max_nprim, max_am, 1));
        engine2_ =
            std::unique_ptr<libint2::Engine>(new libint2::Engine(libint2::Operator::overlap, max_nprim, max_am, 2));
    }
